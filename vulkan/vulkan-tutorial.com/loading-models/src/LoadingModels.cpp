...
void LoadingModels::createInstance()
{
...
bool LoadingModels::checkValidationLayerSupport()
{
...
std::vector<const char*> LoadingModels::getRequiredExtensions()
{
...
void LoadingModels::setupDebugMessenger()
{
	if(!enableValidationLayers)
		return;
...
void LoadingModels::createSurface()
{
...
void LoadingModels::pickPhysicalDevice()
{
...
void LoadingModels::createLogicalDevice()
{
...
void LoadingModels::createFramebuffers()
{
...
void LoadingModels::createCommandPool()
{
...
void LoadingModels::createSyncObjects()
{
...
void LoadingModels::cleanup()
{
	glfwDestroyWindow(window);
	glfwTerminate();
}

bool LoadingModels::isDeviceSuitable(vk::PhysicalDevice device)
{
...
bool LoadingModels::checkDeviceExtensionSupport(vk::PhysicalDevice device)
{
...
void LoadingModels::recreateSwapChain()
{
	int width = 0;
	int height = 0;
...
void LoadingModels::createDescriptorPool()
{
...
void LoadingModels::createDescriptorSets()
{
...
void LoadingModels::createSwapChain()
{
...
vk::Extent2D LoadingModels::chooseSwapExtent(const vk::SurfaceCapabilitiesKHR& capabilities)
{
...
vk::PresentModeKHR LoadingModels::chooseSwapPresentMode(const std::vector<vk::PresentModeKHR>& avaialablePresentModes)
{
...
vk::SurfaceFormatKHR LoadingModels::chooseSwapSurfaceFormat(const std::vector<vk::SurfaceFormatKHR>& availableFormats)
{
...
SwapChainSupportDetails LoadingModels::querySwapChainSupport(vk::PhysicalDevice device)
{
...
vk::UniqueImageView LoadingModels::createImageView(vk::Image image, vk::Format format, vk::ImageAspectFlags aspectFlags)
{
...
void LoadingModels::createImageViews()
{
...
void LoadingModels::createDepthResources()
{
...
bool LoadingModels::hasStencilComponent(vk::Format format)
{
	return format == vk::Format::eD32SfloatS8Uint || format == vk::Format::eD24UnormS8Uint;
}

vk::Format LoadingModels::findDepthFormat()
{
	return findSupportedFormat({vk::Format::eD32SfloatS8Uint, vk::Format::eD24UnormS8Uint, vk::Format::eD32Sfloat},
		vk::ImageTiling::eOptimal, vk::FormatFeatureFlagBits::eDepthStencilAttachment);
}

vk::Format LoadingModels::findSupportedFormat(
...
void LoadingModels::createRenderPass()
{
...
void LoadingModels::createDescriptorSetLayout()
{
...
void LoadingModels::createGraphicsPipeline()
{
...
void LoadingModels::updateUniformBuffer(uint32_t currentImage)
{
...
vk::UniqueShaderModule LoadingModels::createShaderModule(const std::vector<char>& code)
{
...
vk::UniqueCommandBuffer LoadingModels::beginSingleTimeCommands()
{
...
void LoadingModels::endSingleTimeCommands(vk::UniqueCommandBuffer&& commandBuffer)
{
	commandBuffer->end();
...
void LoadingModels::copyBuffer(vk::Buffer srcBuffer, vk::Buffer dstBuffer, vk::DeviceSize size)
{
...
void LoadingModels::copyBufferToImage(vk::Buffer srcBuffer, vk::Image dstImage, uint32_t width, uint32_t height)
{
	auto copyCommandBuffer = beginSingleTimeCommands();
...
void LoadingModels::transitionImageLayout(
...
std::pair<vk::UniqueBuffer, vk::UniqueDeviceMemory> LoadingModels::createBuffer(
...
std::pair<vk::UniqueImage, vk::UniqueDeviceMemory> LoadingModels::createImage(uint32_t width, uint32_t height,
...
void LoadingModels::createIndexBuffer()
{
...
void LoadingModels::createUniformBuffers()
{
...
void LoadingModels::createCommandBuffers()
{
	auto allocInfo = vk::CommandBufferAllocateInfo()
						 .setCommandPool(commandPool.get())
						 .setLevel(vk::CommandBufferLevel::ePrimary)
...
uint32_t LoadingModels::findMemoryType(uint32_t typeFilter, vk::MemoryPropertyFlags properties)
{
...
QueueFamilyIndices LoadingModels::findQueueFamilies(vk::PhysicalDevice device)
{
