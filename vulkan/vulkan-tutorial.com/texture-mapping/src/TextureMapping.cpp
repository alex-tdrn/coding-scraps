...
{
	TextureMapping* app = reinterpret_cast<TextureMapping*>(glfwGetWindowUserPointer(window));
...
bool TextureMapping::isDeviceSuitable(vk::PhysicalDevice device)
{
...
vk::Extent2D TextureMapping::chooseSwapExtent(const vk::SurfaceCapabilitiesKHR& capabilities)
{
...
vk::PresentModeKHR TextureMapping::chooseSwapPresentMode(const std::vector<vk::PresentModeKHR>& avaialablePresentModes)
{
...
vk::SurfaceFormatKHR TextureMapping::chooseSwapSurfaceFormat(const std::vector<vk::SurfaceFormatKHR>& availableFormats)
{
...
SwapChainSupportDetails TextureMapping::querySwapChainSupport(vk::PhysicalDevice device)
{
...
vk::UniqueShaderModule TextureMapping::createShaderModule(const std::vector<char>& code)
{
...
uint32_t TextureMapping::findMemoryType(uint32_t typeFilter, vk::MemoryPropertyFlags properties)
{
...
QueueFamilyIndices TextureMapping::findQueueFamilies(vk::PhysicalDevice device)
{
