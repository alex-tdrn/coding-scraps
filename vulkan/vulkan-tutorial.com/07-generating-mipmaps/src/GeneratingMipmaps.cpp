...
{
	GeneratingMipmaps* app = reinterpret_cast<GeneratingMipmaps*>(glfwGetWindowUserPointer(window));
...
void GeneratingMipmaps::initWindow()
{
	glfwInit();
...
void GeneratingMipmaps::initVulkan()
{
	createInstance();
	setupDebugMessenger();
	createSurface();
...
void GeneratingMipmaps::createInstance()
{
...
bool GeneratingMipmaps::checkValidationLayerSupport()
{
...
std::vector<const char*> GeneratingMipmaps::getRequiredExtensions()
{
...
void GeneratingMipmaps::setupDebugMessenger()
{
	if(!enableValidationLayers)
		return;
...
void GeneratingMipmaps::createSurface()
{
...
void GeneratingMipmaps::pickPhysicalDevice()
{
...
void GeneratingMipmaps::createLogicalDevice()
{
...
void GeneratingMipmaps::createFramebuffers()
{
...
void GeneratingMipmaps::createCommandPool()
{
...
void GeneratingMipmaps::createSyncObjects()
{
...
void GeneratingMipmaps::mainLoop()
{
...
void GeneratingMipmaps::cleanup()
{
	glfwDestroyWindow(window);
	glfwTerminate();
}

bool GeneratingMipmaps::isDeviceSuitable(vk::PhysicalDevice device)
{
...
bool GeneratingMipmaps::checkDeviceExtensionSupport(vk::PhysicalDevice device)
{
...
void GeneratingMipmaps::drawFrame()
{
...
void GeneratingMipmaps::recreateSwapChain()
{
	int width = 0;
	int height = 0;
...
void GeneratingMipmaps::createDescriptorPool()
{
...
void GeneratingMipmaps::createDescriptorSets()
{
...
void GeneratingMipmaps::createSwapChain()
{
...
vk::Extent2D GeneratingMipmaps::chooseSwapExtent(const vk::SurfaceCapabilitiesKHR& capabilities)
{
...
vk::PresentModeKHR GeneratingMipmaps::chooseSwapPresentMode(
...
vk::SurfaceFormatKHR GeneratingMipmaps::chooseSwapSurfaceFormat(
...
SwapChainSupportDetails GeneratingMipmaps::querySwapChainSupport(vk::PhysicalDevice device)
{
...
vk::UniqueImageView GeneratingMipmaps::createImageView(
...
void GeneratingMipmaps::createImageViews()
{
...
void GeneratingMipmaps::createDepthResources()
{
...
bool GeneratingMipmaps::hasStencilComponent(vk::Format format)
{
	return format == vk::Format::eD32SfloatS8Uint || format == vk::Format::eD24UnormS8Uint;
}

vk::Format GeneratingMipmaps::findDepthFormat()
{
	return findSupportedFormat({vk::Format::eD32SfloatS8Uint, vk::Format::eD24UnormS8Uint, vk::Format::eD32Sfloat},
		vk::ImageTiling::eOptimal, vk::FormatFeatureFlagBits::eDepthStencilAttachment);
}

vk::Format GeneratingMipmaps::findSupportedFormat(
...
void GeneratingMipmaps::createRenderPass()
{
...
void GeneratingMipmaps::createDescriptorSetLayout()
{
...
void GeneratingMipmaps::createGraphicsPipeline()
{
...
void GeneratingMipmaps::updateUniformBuffer(uint32_t currentImage)
{
...
vk::UniqueShaderModule GeneratingMipmaps::createShaderModule(const std::vector<char>& code)
{
...
vk::UniqueCommandBuffer GeneratingMipmaps::beginSingleTimeCommands()
{
...
void GeneratingMipmaps::endSingleTimeCommands(vk::UniqueCommandBuffer&& commandBuffer)
{
	commandBuffer->end();
...
void GeneratingMipmaps::copyBuffer(vk::Buffer srcBuffer, vk::Buffer dstBuffer, vk::DeviceSize size)
{
...
void GeneratingMipmaps::copyBufferToImage(vk::Buffer srcBuffer, vk::Image dstImage, uint32_t width, uint32_t height)
{
	auto copyCommandBuffer = beginSingleTimeCommands();
...
void GeneratingMipmaps::transitionImageLayout(
...
std::pair<vk::UniqueBuffer, vk::UniqueDeviceMemory> GeneratingMipmaps::createBuffer(
...
std::pair<vk::UniqueImage, vk::UniqueDeviceMemory> GeneratingMipmaps::createImage(uint32_t width, uint32_t height,
...
void GeneratingMipmaps::loadModel()
{
...
void GeneratingMipmaps::createVertexBuffer()
{
...
void GeneratingMipmaps::createTextureImage()
{
...
void GeneratingMipmaps::createTextureSampler()
{
...
void GeneratingMipmaps::createIndexBuffer()
{
...
void GeneratingMipmaps::createUniformBuffers()
{
...
void GeneratingMipmaps::createCommandBuffers()
{
	auto allocInfo = vk::CommandBufferAllocateInfo()
						 .setCommandPool(commandPool.get())
						 .setLevel(vk::CommandBufferLevel::ePrimary)
...
uint32_t GeneratingMipmaps::findMemoryType(uint32_t typeFilter, vk::MemoryPropertyFlags properties)
{
...
QueueFamilyIndices GeneratingMipmaps::findQueueFamilies(vk::PhysicalDevice device)
{
